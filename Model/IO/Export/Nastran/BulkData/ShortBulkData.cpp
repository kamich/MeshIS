...
decltype(auto) MeshIS::Model::Export::Nastran::BData::ShortBulkData::get_line_from_mesh_part(type_of_mesh_part mesh_part, int ID)
{
	string line{ "" };
	set_id(line, ID);
...
decltype(auto) ShortBulkData::set_cell_from_string(string some_string)
{
...
void MeshIS::Model::Export::Nastran::BData::ShortBulkData::set_string_according_to_its_length(string & some_string,int length)
{
	if (length > 8)
...
void MeshIS::Model::Export::Nastran::BData::ShortBulkData::fill_out_spaces(string & some_string, int length)
{
